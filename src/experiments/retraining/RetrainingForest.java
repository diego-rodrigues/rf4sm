...
public class RetrainingForest {
	...
	public static void main(String[] args) {
		...
		for (randSeed = 0; randSeed < 30; randSeed++){
			...
			String logFileName = EXPERIMENTS + "logs/RetrainingForest/"+ domain + "/" + MIN_AGREEMENT + "-" + domain + "-" + NUMBER_OF_TREES_COMMITTEE + "-" + Integer.toString(randSeed) + ".log.txt";
			try {
