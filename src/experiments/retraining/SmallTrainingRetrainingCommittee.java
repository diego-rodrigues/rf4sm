...
public class SmallTrainingRetrainingCommittee {
	...
	public static void main(String[] args) {
		...
		for (randSeed = 0; randSeed < 30; randSeed++){
			...
			String logFileName = EXPERIMENTS + "logs/SmallTrainingRetrainingCommittee/"+ domain + "/" + MIN_AGREEMENT + "-" + domain + "-" + NUMBER_OF_TREES_COMMITTEE + "-" + Integer.toString(randSeed) + ".log.txt";
			try {
