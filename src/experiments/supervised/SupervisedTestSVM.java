...
public class SupervisedTestSVM {
	...
	static double TRAINING_PERCENTAGE = 10;
	//to run this, change the weka package to 3.7
...
//			String arffFileName = EXPERIMENTS + "ARFF/MatchingNetwork-" + domain + "-COMA-Matcher.arff";
			...
			String logFileName = EXPERIMENTS + "logs/SupervisedTests/training" + (int)(TRAINING_PERCENTAGE) + "/" + domainList[DOMAIN_ID] + "-" + Integer.toString(randSeed) + ".SVM.log.txt";
...
//			Functions.createFixedPNTrainingAndTest(trainingInstances, testInstances, allInstances, 15, 35, r);
			...
			String[] classifiersNames = {"LibSVM"};
