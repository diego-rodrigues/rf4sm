...
public class ReconciliationAfterTrainingGenGephi {
...
//			trueInstancesByOracle.addAll(MatchesFunctions.getNetworkAcceptedMatches());
			...
			System.out.printf("> %s Network answers - COMA base system - after reconciliation.\n", domain);
			for (int id:trueInstancesByOracle)
				System.out.printf("%s\n", instancesController.getMatchingCandidateLabel(id));
			for (int id:userConfirmedMatches)
				System.out.printf("%s\n", instancesController.getMatchingCandidateLabel(id));
			for (int id:networkAcceptedMatches)
				System.out.printf("%s\n", instancesController.getMatchingCandidateLabel(id));
